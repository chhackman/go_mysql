...
func (m *MockUserDAO) EditUserProfile(ctx context.Context, uid int64, u dao.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EditUserProfile", ctx, uid, u)
	ret0, _ := ret[0].(error)
	return ret0
}

// EditUserProfile indicates an expected call of EditUserProfile.
func (mr *MockUserDAOMockRecorder) EditUserProfile(ctx, uid, u interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EditUserProfile", reflect.TypeOf((*MockUserDAO)(nil).EditUserProfile), ctx, uid, u)
}
