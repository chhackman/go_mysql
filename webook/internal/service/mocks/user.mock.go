...
func (m *MockUserService) EditUserProfile(ctx context.Context, id int64, u domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EditUserProfile", ctx, id, u)
	ret0, _ := ret[0].(error)
	return ret0
}

// EditUserProfile indicates an expected call of EditUserProfile.
func (mr *MockUserServiceMockRecorder) EditUserProfile(ctx, id, u interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EditUserProfile", reflect.TypeOf((*MockUserService)(nil).EditUserProfile), ctx, id, u)
}
...
func (m *MockUserService) SendSMS(ctx context.Context) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SendSMS", ctx)
}

// SendSMS indicates an expected call of SendSMS.
func (mr *MockUserServiceMockRecorder) SendSMS(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendSMS", reflect.TypeOf((*MockUserService)(nil).SendSMS), ctx)
}
